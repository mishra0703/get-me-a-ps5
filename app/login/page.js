...
const page = () => {
  ...
  return (
    <div>
      <div className="text-white container mx-auto mt-[20vh] min-h-screen">
        <h1 className="text-center font-bold text-5xl max-sm:text-2xl my-5">
        ...
        <div className="flex flex-col gap-3 items-center  p-10">
          <button
            ...
            className="flex items-center w-64 bg-slate-50 text-black border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:cursor-pointer hover:bg-transparent hover:text-white hover:backdrop-blur-[1px] transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
          >
            <svg
          ...
          <button
            ...
            className="flex items-center w-64 bg-[#3a3a3a] text-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
            disabled
          >
            <svg
              className="h-6 w-6 mr-2"
